...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    addToWatchlist: Schema.Attribute.Enumeration<['Yes', 'No']>;
    articleTitle: Schema.Attribute.String;
    articleType: Schema.Attribute.Enumeration<
      ['Recommendation List', 'Long Post', 'Review Post']
    > &
      Schema.Attribute.Required;
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    recommendationList: Schema.Attribute.Component<
      'element.film-tv-books-list',
      true
    >;
...
export interface ApiCurrentlyReadingCurrentlyReading
  extends Struct.CollectionTypeSchema {
  collectionName: 'currently_readings';
  info: {
    displayName: 'Currently Reading';
    pluralName: 'currently-readings';
    singularName: 'currently-reading';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::currently-reading.currently-reading'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiHomepageHomepage extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Homepage content and featured sections';
...
export interface ApiPagePage extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    Sections: Schema.Attribute.DynamicZone<
      ['element.hero', 'element.image-grid', 'element.quote', 'element.content']
    >;
    Slug: Schema.Attribute.UID<'Title'>;
    Title: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiPlateformPlateform extends Struct.CollectionTypeSchema {
  collectionName: 'plateforms';
  info: {
    displayName: 'Plateform';
    pluralName: 'plateforms';
    singularName: 'plateform';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiWatchListWatchList extends Struct.CollectionTypeSchema {
  ...
  info: {
    displayName: 'Watch List (Pending)';
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::currently-reading.currently-reading': ApiCurrentlyReadingCurrentlyReading;
